...
class _AdminUsersState extends State<AdminUsers> {
  final CollectionReference usersRef = FirebaseFirestore.instance.collection('utilisateurs');
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final filtered = snapshot.data!.docs.where((doc) {
                  ...
                  final matchesRole = roleFilter == 'TOUS' || role == roleFilter;
  ...
  Future<void> _showUserFormDialog({String? docId, Map<String, dynamic>? existingData}) async {
    ...
    await showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (context, setStateDialog) {
          return AlertDialog(
            title: Text(docId == null ? "Ajouter un utilisateur" : "Modifier l'utilisateur"),
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxListTile(
                    ...
                    value: aDemande,
                    onChanged: (val) => setStateDialog(() => aDemande = val ?? false),
